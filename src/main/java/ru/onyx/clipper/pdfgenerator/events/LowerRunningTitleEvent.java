...
import ru.onyx.clipper.pdfgenerator.model.BaseReportObject;
 ...
 */
public class LowerRunningTitleEvent extends PdfPageEventHelper {
    /** The header text. */
    String header;
    String pageNumType;
    String pageText;
    ...
    public LowerRunningTitleEvent(Report rep, Document _document, Font headerFont) {
        _doc = _document;
